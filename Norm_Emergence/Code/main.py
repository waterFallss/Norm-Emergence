...
'''
class Agent:
    def __init__(self, id, N, p_init=0.9, p_end=0.001):
...
def main():  
    ...
    # num_converge_two = 0
    # not_converged = 0
    # k_last_ep = 5000 # Last k episodes to check fraction of time each action was taken
    # count = 1
    
    # options = [num_agents]
    # num_convergence = {}
    # for option in options:
    #     num_convergence[option] = []
    # num_experiment = 1
    ...
    #         agent_actions, chosen_option, agent_reward, percentage, avg_reward, q_ops, q_val_agent, q_vals, frac_k_last = initial_set_run(num_agents,
    #             num_episodes, k_last_action_second=10,k_last_ep=k_last_ep, network_type="grid", exploration_type="epsilon_greedy", matrix_row=10,
    #             matrix_col=10, num_neighbor=4)
    #         (converged, converge_to_one) = does_converge(frac_k_last, prob_threshold=0.9)
    #         if converged:
    #             if converge_to_one:
    #                 num_converged += 1
    #                 print("ONE")
    ...
    #         for i in range(num_options):
    #             plt.scatter(x_axis, frac_k_last[i], c=[colors[i]], alpha=1)

    #         plt.title("Fraction of Time Each Action was Taken Over the Last " + str(k_last_ep) + " Episodes")
    #         plt.xlabel("Episode")
    #         plt.ylabel("Fraction of Time Taken")
    #         plt.show()
    #         clear_all()
    # reset_option_num() # Reset the number of options to original
    
    
    # # Effect of Changing the Number of Agents ########################################################
    # agent_num = [300, 400, 500]
    # num_convergence = {}
    # for option in agent_num:
    #     num_convergence[option] = []
    # num_experiment = 20
    # num_episodes = 2000
    # num_converge_one = 0
    # num_converge_two = 0
    # not_converged = 0
    # k_last_ep = 2000 # Last k episodes to check fraction of time each action was taken
    # count = 1
    
    # for num_agent in agent_num:
    #     print("Number of Agents: ", num_agent)
    #     num_converged = 0
    #     (agent_row, agent_col) = closest_square_factors(num_agent)
    #     for _ in range(num_experiment):
    #         agent_actions, chosen_option, agent_reward, percentage, avg_reward, q_ops, q_val_agent, q_vals, frac_k_last = run_exp(num_agent,
    #             num_episodes, k_last_action_second=10,k_last_ep=k_last_ep, network_type="grid", exploration_type="epsilon_greedy", matrix_row=agent_row,
    #             matrix_col=agent_col, num_neighbor=4)
    #         (converged, converge_to_one) = does_converge(frac_k_last, prob_threshold=0.9)
    #         if converged:
    #             if converge_to_one:
    #                 num_converged += 1
    ...
    #                 num_converged += 1
    #                 print("TWO")
    #         num_convergence[num_agent].append(num_converged)
    #         clear_all()
    # for num in agent_num:
    #     print("Number of Agents: ", num)
    #     print(num_convergence[num])
    # # Plot a graph of the number of times each option converged for each option
    # for option in agent_num:
    #     plt.scatter(range(num_experiment), num_convergence[option])
    # plt.title("Number of Times Each Option Converged for Each Option")
    # plt.xlabel("Number of Agents")
    # plt.ylabel("Number of Times Converged")
    # plt.show()
    
    
    
    # # Effect of Changing the Number of Actions ########################################################
    # # Cumulative number of convergence for each option
    # options = [2,4,6,8,10]
    # num_convergence = {}
    # for option in options:
    #     num_convergence[option] = []
    ...
    #     num_converged = 0
    #     for _ in range(num_experiment):
    #         agent_actions, chosen_option, agent_reward, percentage, avg_reward, q_ops, q_val_agent, q_vals, frac_k_last = run_exp(num_agents,
    #             num_episodes, k_last_action_second=10,k_last_ep=k_last_ep, network_type="grid", exploration_type="epsilon_greedy", matrix_row=10,
    #             matrix_col=10, num_neighbor=4)
    #         (converged, converge_to_one) = does_converge(frac_k_last, prob_threshold=0.9)
    #         if converged:
    ...
    #                 num_converged += 1
    #                 print("TWO")
    #         num_convergence[option].append(num_converged)
    #         clear_all()
    # reset_option_num() # Reset the number of options to original
    
    ## Print Number Converged for Each Option
    # for option in options:
    #     print("Option: ", option)
    #     print(num_convergence[option])
    # Plot a graph of the number of times each option converged for each option
    # for option in options:
    #     plt.scatter(range(num_experiment), num_convergence[option])
    # plt.title("Number of Times Each Option Converged for Each Option")
    ...
    #         print("NOT CONVERGED")
        ...
        # for option_num in range(num_options):
        #     plt.scatter(range(num_episodes), chosen_option[option_num])
        # plt.title("Number of Times Each Option was Chosen")
        # plt.xlabel("Episode")
        # plt.ylabel("Number of Times Chosen")
        # plt.show()
        
        # # Q-Values for Each Agent in Each Episode
        for option_num in range(num_options):
            for agent in range(num_agents):
                plt.scatter(range(num_episodes), q_vals[agent][option_num])

            plt.title("Q-Values for Each Agent (Action: " + str(option_num+1) + ")")
            plt.xlabel("Episode")
            plt.ylabel("Q-Value")
            plt.show()
        ########################################################################################################
        ...
        print("Round #: ", count)
        count += 1
    print("Converge to One: ", num_converge_one)
    print("Converge to Two: ", num_converge_two)

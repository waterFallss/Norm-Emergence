''''
Description:
Effect of Increasing the Number of Episodes on the Number of Convergence when w2 = 1
'''
...
def main():      
    ...
    for x in range(num_rounds):
        ...
        # # plt.title("Frequency of Chosen Actions Over the Last " + str(k_last_ep) + " Episodes")

...
weight_one = 0.33 # Q Value
weight_two = 0.33 # Observation as Second Player
weight_three = 0.33 # All Neighbors
...
def main():    
    ...
    for x in range(num_rounds):
        ...
        _, _, _, _, _, _, _, _, _, first_conv = run_exp(num_agents,
            num_episodes, k_last_action_second=10,k_last_ep=k_last_ep, network_type="scale_free", exploration_type="epsilon_greedy", matrix_row=10,

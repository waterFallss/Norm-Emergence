...
def main():      
    ...
    k_obs = 10 # Number of previous observations to look at for w_2
    ...
    for x in range(num_rounds):
        ...
        _, _, _, _, _, _, _, _, frac_k_last, first_conv = run_exp(num_agents,
            num_episodes, k_last_action_second=k_obs,k_last_ep=k_last_ep, network_type="grid", exploration_type="epsilon_greedy", matrix_row=10,

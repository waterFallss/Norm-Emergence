...
'''
The number of options equals the number of agents that are present.
Each agent are initially assigned to an option belonging to them. (e.g. Agent 1 is assigned to option 1)
...
'''
Initially, all agents choose their assigned action. (e.g. Agent 1 chooses action 1)
'''

...
def main():    
    ...
    for x in range(num_rounds):
        episode_conv = find_first_convergence(num_agents=num_agents, num_exp_runs=num_episodes, k_last_action_second=k_last_action_second
            , network_type="grid", exploration_type="epsilon_greedy", matrix_row=10, matrix_col=10
            , num_neighbor=4, x_conv=1)
        episodes_to_conv.append(episode_conv)
        count += 1
        print("Episode Number: ", episode_conv, "Count: ", count)
        clear_all()
        
    print("Episodes to Convergence: ", episodes_to_conv)

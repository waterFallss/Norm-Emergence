...
'''
Shows the Q-Values for each agent per episode for each actions when only w_1 (Q value) is considered.
...
def main():  
    ...
    #     # q_vals: Q values for each agent
        ...
        for option_num in range(num_options):
            ...
            plt.title("Q-Values for Each Agent (Action: " + str(option_num+1) + ")", fontsize=15)
